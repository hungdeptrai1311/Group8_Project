                    ...
                    <div class="modal-content">
                        <form action="edit_product" method="post">
                            <div class="modal-header">						
                                ...
                                <a href="/Group8_Project/products_list"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                            </div>
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${product.quantity}" name="quantity" class="form-control" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="brand" class="form-select" aria-label="Default select example">
                                        <c:forEach items="${requestScope.brands}" var="b">
                                            <option value="${b.brand_id}"  <c:if test="${product.brand.brand_id eq b.brand_id}">selected</c:if>>${b.brand_name}</option>
                                        </c:forEach>
                                    </select>
                                </div>
